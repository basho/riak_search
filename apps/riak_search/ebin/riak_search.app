{application, riak_search,
 [
  ...
  {modules, [
             ...
             riak_search_op,
             riak_search_op_group,
             riak_search_op_intersection,
             riak_search_op_negation,
             riak_search_op_scope,
             riak_search_op_string,
             riak_search_op_union,
             riak_search_op_term,
             riak_search_op_range,
             riak_search_op_range_sized,
             ...
             riak_search_shell,
             riak_search_test,
             riak_search_op_utils,
             riak_search_ring_utils,
             riak_search_utils,
             riak_search_vnode,
